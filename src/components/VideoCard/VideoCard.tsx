import {
  forwardRef, PropsWithChildren, useCallback, useRef, useState,
} from 'react';
  ...
  return (
    ...
    >
      <div
        ...
        className={classNames(
          {
            'relative h-[140px] w-[300px] sm:h-[230px] sm:w-[470px]': trending,
            'relative mb-4 grow basis-1/5 duration-500 h-[133px] md:h-[140px] lg:h-[174px]': !trending,
            'w-full': !trending && isSearch,
            'w-[150px] sm:w-[180px] sm:w-[200px] lg:w-[268px] group-hover:w-[300px]': !trending && !isSearch,
          },
        )}
      >
        <YoutubePlayer
